  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column' }}>
      <div style={{
        ...
        <p style={{ fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: 22, margin: 0, textAlign: 'center' }}>{t('sceltaSede.titolo')}</p>
        <p style={{ fontSize: 13, margin: 0, opacity: 0.85 }}>{t('sceltaSede.sottotitolo')}</p>
      </div>
            ...
            <Card key={sede.id} style={{ padding: 0 }}>
              ...
              >
                <span style={{ fontSize: 16, fontWeight: 600, color: 'var(--espresso)' }}>
                  {sede.aziende?.nome || t('sceltaSede.sedeSenzaNome')}
                </span>
